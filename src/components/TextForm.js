  ...
  return (
    <>
      <div className="mb-3 container my-4" style={{color: props.mode === 'light'?'black':'white'}}>
        ...
        ></textarea>
        <button type="button" className="btn btn-primary my-3" onClick={convertupper}> {props.button}</button>
        <button type="button" className="btn btn-primary my-3 mx-2" onClick={convertlower}> Convert to Lowercase</button>
